...
local theme = lush(function(injected_functions)
  ...
  return {
    ...
    sym("@function.builtin.zig")                       { fg = hsl(p.teal_muted) },
    ...
    sym("@type.builtin.cpp")                           { fg = hsl(p.blue) },
    ...
    sym("@variable.member.zig")                        { fg = hsl(p.fg) },
    sym("@variable.builtin.zig")                       { fg = hsl(p.blue_muted) },
    ...
    sym("@lsp.type.builtin.zig")                       { fg = hsl(p.teal_muted) },
    ...
    sym("@lsp.typemod.typeParameter.functionScope.cpp") { fg = hsl(p.blue) },
